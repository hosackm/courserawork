...
if __name__ == "__main__":
    s1 = np.sin(2. * np.pi * 80 * np.arange(0, 1, 1/10000.))
    s2 = np.sin(2. * np.pi * 200 * np.arange(0, 1, 1/10000.))

    X = minimizeEnergySpreadDFT(s1+s2, 10000., 80., 200.)
    print(X, len(X))

    s1 = np.sin(2. * np.pi * 300 * np.arange(0, 1, 1/48000.))
    s2 = np.sin(2. * np.pi * 800 * np.arange(0, 1, 1/48000.))

    X = minimizeEnergySpreadDFT(s1+s2, 48000., 300., 800.)
    print(X, len(X))
