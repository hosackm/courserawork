...
if __name__ == "__main__":
    s = np.sin(2. * np.pi * 100 * np.arange(0, 2.*np.pi, 1/1000.))[:25]
    X = optimalZeropad(s, 1000, 100)
    print(X, len(X))
    

    s = np.sin(2. * np.pi * 250 * np.arange(0, 2.*np.pi, 1/10000.))[:210]
    X = optimalZeropad(s, 10000, 250)
    print(X, len(X))
