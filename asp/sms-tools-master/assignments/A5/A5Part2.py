...
"""
def chirpTracker(inputFile='../../sounds/chirp-150-190-linear.wav', M=1023):
    """
    Input:
...
if __name__ == "__main__":
    ...
    M = 1001
    while True:
        print("Simulating with {}".format(M))
        err = chirpTracker(M=M)
        if err[0] < 2. and err[1] < 2.:
            break
        print("Error was {}".format(err))
        M += 100
    print("Error was {} with a size of {}".format(err, M))
