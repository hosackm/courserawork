...
if __name__ == "__main__":
    # t = -40
    # windows = ['blackman', 'blackmanharris', 'hamming', 'hanning']
    # while True:
    #     for window in windows:
    #         print("Simulating with t={} window='{}'".format(t, window))
    #         err = mainlobeTracker(window=window, t=t)
    #         print("Error was: {}".format(err))
    #         if err[0] < 2. and err[1] < 2.:
    #             break
    #         t -= 1
    # print("Error is {} with t={} and window={}".format(err, t, window))
